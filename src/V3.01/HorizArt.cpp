...
void HorizArt::reDraw()
{
  ...
  ptr_tft->setCursor (4, 157); ptr_tft->print("IAT");
  ptr_tft->setCursor (4, 172); ptr_tft->print("OAT");
  ptr_tft->setCursor (4, 187); ptr_tft->print("RH");
  ptr_tft->setCursor (4, 202); ptr_tft->print("DPT");
  ...
  ptr_tft->drawRect(1, 156, 98, 65, RA8875_WHITE);
