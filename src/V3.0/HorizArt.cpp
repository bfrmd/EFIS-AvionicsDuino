...
void HorizArt::reDraw()
{
  ...
  ptr_tft->setTextColor (RA8875_WHITE, RA8875_PINK);
  byte j = 0;
  for (uint16_t i = 0; i <= 272; i = i + 58) 
  {
    ptr_tft->setCursor(470, i-j*2);
    ptr_tft->print(abs(2 - j));
    j++;
  }
  ptr_tft->drawFastVLine (460, 20-14, 232, RA8875_WHITE);
  ...
  ptr_tft->setCursor(302, 0); ptr_tft->print("TRK");
  //ptr_tft->setCursor(175, 20); ptr_tft->print("HDG");
  ptr_tft->setCursor(155, 0); ptr_tft->print("HDG");
  ptr_tft->setCursor(3, 82); ptr_tft->print("GND");
  ptr_tft->setCursor(3, 97); ptr_tft->print("TAS");
  ...
  ptr_tft->setCursor (4, 160); ptr_tft->print("IAT");
  ptr_tft->setCursor (4, 175); ptr_tft->print("OAT");
  ptr_tft->setCursor (4, 190); ptr_tft->print("RH");
  ptr_tft->setCursor (4, 205); ptr_tft->print("DPT");
  ...
  ptr_tft->setCursor (378, 0); ptr_tft->print("Vert");
  ptr_tft->setCursor (407, 0); ptr_tft->print(".SPEED");
  ...
  ptr_tft->fillRect(242, 1, 60, 22, RA8875_BLACK);
  ptr_tft->drawRect(242, 1, 60, 22, RA8875_LIGHT_GREY);
  ptr_tft->fillRect(179, 1, 60, 22, RA8875_BLACK);
  ptr_tft->drawRect(179, 1, 60, 22, RA8875_LIGHT_GREY);

  // Dessin des cadres d'affichages températures, G, altP&D, QNH/QFE,varios, wind, nbSat, speeds (dans cet ordre)
  ptr_tft->drawRect(1, 156, 98, 68, RA8875_WHITE);
  ...
  ptr_tft->drawRect(1, 1, 98, 47, RA8875_WHITE);
  ptr_tft->drawRect(1, 47, 98, 20, RA8875_WHITE);
  ptr_tft->drawRect(1, 66, 98, 91, RA8875_WHITE);
